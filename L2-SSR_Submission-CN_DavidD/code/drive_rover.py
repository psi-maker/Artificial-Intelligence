...
class RoverState():
    def __init__(self):
        ...
        # per the source and dst perspective , 1 pixel = 0.1 meter
        self.stop_forward = 50 # Threshold to initiate stopping
        self.go_forward = 500 # Threshold to go forward again
        self.time_5s = None # check rover status by interval 5 seconds
        self.s_pos = None # rover position before 5 seconds
        self.barrier = 0
        
        self.max_vel = 40 # Maximum velocity (meters/second)
